...
export default function GlobalError({
  ...
  return (
    <html lang="pt-BR" className="dark">
      <body className="min-h-screen bg-[#050507] text-[#fafafa] flex items-center justify-center p-4 sm:p-6 aurora-bg">
        <div className="w-full max-w-md p-6 sm:p-8 rounded-3xl bg-[#0d0d14] border border-amber-500/30 shadow-2xl space-y-5 text-center">
          ...
          <div className="space-y-1.5">
            ...
            <h1 className="text-xl sm:text-2xl font-black text-white tracking-tight">
              Ops! Ocorreu uma instabilidade temporária.
            </h1>
            <p className="text-xs text-zinc-400 max-w-sm mx-auto font-normal leading-relaxed">
              O English Lab blindou a sua sessão. Seus dados e vocabulário continuam seguros no banco de dados.
            </p>
          </div>
